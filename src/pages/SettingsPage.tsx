...
const sections: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'maximum_support_distance_pct', label: 'Maximum Support Distance', type: 'number', unit: '%', step: '1', help: 'Maximum percentage the put strike can be below support. Strikes too far below support may have insufficient premium.' },
    ],
  },
];
